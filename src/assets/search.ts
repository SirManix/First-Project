const quran = `بسم الله الرحمن الرحيم
...
من الجنة والناس
`;
//put all quran in array,each ayah is an element of this array
export const quranArray = quran.split("\n");
//search method
// let searchMethod = function (searchKeyWord: string) {
//   let answer = [];
//   for (let i = 0; i < 500; i++) {
//     //   search method would return a number as result
//     let searchResult = quranArray[i].search(searchKeyWord);
//     if (searchResult !== -1) {
//       answer.push(quranArray[i]);
//       console.log(answer);
//     }
